    ...
    <div>
      <div className="min-h-screen bg-gradient-to-br from-rose-50 via-amber-50 to-rose-50 py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-3xl shadow-2xl border border-rose-100 overflow-hidden mt-8">
            <div className="p-8">
              <h3 className="text-2xl font-bold text-center text-gray-900 mb-6 font-serif">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  to="/create-wedding"
                  className="flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white font-semibold rounded-2xl shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 group"
                >
                  <span className="text-xl">💍</span>
                  Create New Wedding
                </Link>

                <div className="flex items-center gap-3 px-8 py-4 bg-white border border-rose-300 text-gray-700 font-semibold rounded-2xl shadow-lg">
                  <span className="text-xl">🔍</span>
                  <input
                    type="text"
                    ...
                    className="outline-none bg-transparent"
                      ...
                      if (e.key === "Enter") {
                        ...
                        if (code) {
                          window.location.href = `/tree/${code}`;
                        }
                      }
                    }}
                  />
