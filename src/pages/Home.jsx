        ...
        <div className="bg-white rounded-3xl shadow-2xl border border-rose-100 overflow-hidden transform hover:shadow-3xl transition-all duration-300">
          ...
          <div className="relative bg-gradient-to-r from-rose-500 to-amber-500 px-8 py-8 overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl font-bold text-white font-serif mb-2">Join Our Family Story</h2>
          ...
          <div className="p-8">
            <div className="flex flex-col lg:flex-row items-center gap-12">
              ...
              <div className="flex-1 space-y-8">
                ...
                {/* Features */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6 border-t border-rose-200">
                  <div className="text-center group hover:transform hover:-translate-y-1 transition-all duration-300">
                    <div className="w-12 h-12 bg-gradient-to-br from-rose-100 to-amber-100 rounded-2xl flex items-center justify-center mx-auto mb-3 group-hover:shadow-lg transition-shadow">
                      <svg className="w-6 h-6 text-rose-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M5 13l4 4L19 7" />
                      </svg>
                    </div>
                    <p className="text-lg font-semibold text-gray-900 font-serif">Elegant & Simple</p>
                    <p className="text-sm text-gray-600 mt-1">Quick and beautiful setup</p>
                  </div>
                  
                  <div className="text-center group hover:transform hover:-translate-y-1 transition-all duration-300">
                    <div className="w-12 h-12 bg-gradient-to-br from-amber-100 to-rose-100 rounded-2xl flex items-center justify-center mx-auto mb-3 group-hover:shadow-lg transition-shadow">
                      <svg className="w-6 h-6 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                      </svg>
                    </div>
                    <p className="text-lg font-semibold text-gray-900 font-serif">Family Bonds</p>
                    <p className="text-sm text-gray-600 mt-1">Connect generations together</p>
                  </div>
                  
                  <div className="text-center group hover:transform hover:-translate-y-1 transition-all duration-300">
                    <div className="w-12 h-12 bg-gradient-to-br from-rose-100 to-pink-100 rounded-2xl flex items-center justify-center mx-auto mb-3 group-hover:shadow-lg transition-shadow">
                      <svg className="w-6 h-6 text-pink-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14" />
                      </svg>
                    </div>
                    <p className="text-lg font-semibold text-gray-900 font-serif">Lasting Memory</p>
                    <p className="text-sm text-gray-600 mt-1">Cherish forever</p>
                  </div>
                </div>
              </div>
            </div>
